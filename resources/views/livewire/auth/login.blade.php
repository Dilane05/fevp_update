                ...
                <div class="row justify-content-center form-bg-image" data-background-lg="{{asset('img/illustrations/signin.svg')}}">
                    <div class="col-12 d-flex align-items-center justify-content-center ">
                        <div class="bg-white shadow-soft border rounded border-light px-4 pt-3 pb-4 px-lg-5  pt-lg-3  pb-lg-4  w-100 fmxw-500">
                            ...
                            <div class="mb-3 mt-md-0 text-center d-flex justify-content-center">
                                <div class="d-flex text-center">
                                    <img src='/img/logo.png' class="h-auto" style="width: 02em;" alt=''>
                                    <div class="mb-0 px-3"> <span class="text-xl fs-1 fw-bold">{{ __('FEVP')}}</span></div>
                                </div>
                            </div>
                            <x-form-items.form wire:submit.prevent="loginUser" class="mt-1 needs-validation" id="loginForm">

                                <div class="form-group mb-2"><label for="email">{{ __('Matricule') }}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex justify-content-between align-items-top mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="remember" wire:model="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
                                ...
                                <div class="d-grid pb-3">
                                    <button type="submit" class="btn btn-info px-6" wire:attr.disabled="loading"> {{ __('Se Connecter') }}</button>
                                </div>
                            </x-form-items.form>
