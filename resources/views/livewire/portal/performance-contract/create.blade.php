<div wire:ignore.self class="modal side-layout-modal fade" id="CreateContractModal" tabindex="-1"
                        ...
                        <div class="shadow p-2 my-2">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select wire:model="year" class="form-control " id="annee" name="annee"
                                        required>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-control "
                                                        ...
                                                        <option value="">
                                                            {{ __('Selectionner le Type D\'Indicateur') }}</option>
