<div wire:ignore.self class="modal side-layout-modal fade" id="EditPerformanceContract" tabindex="-1"
    aria-labelledby="modal-form" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:84%;">
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="p-2 p-lg-4">
                    <!-- Header -->
                    <div class="mb-4 mt-md-0">
                        <h1 class="mb-0 h4">{{ __('Modification D\'un contrat de performance') }}</h1>
                        <p>{{ __('Modifier un contrat de performance') }} &#128522;</p>
                    </div>
