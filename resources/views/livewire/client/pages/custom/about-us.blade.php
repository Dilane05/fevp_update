...
<section class="about-two about-two--about">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="about-two__thumb wow fadeInLeft animated" data-wow-delay="100ms" style="visibility: visible; animation-delay: 100ms; animation-name: fadeInLeft;"><!-- about thumb start -->
                            <div class="about-two__thumb__one eduact-tilt" data-tilt-options="{ &quot;glare&quot;: false, &quot;maxGlare&quot;: 0, &quot;maxTilt&quot;: 2, &quot;speed&quot;: 700, &quot;scale&quot;: 1 }">
                                <img src="{{asset('img/frontend/resources/about-2-2-about.jpg')}}" alt="eduact">
                            </div><!-- /.about-thumb-one -->
                            <div class="about-two__thumb__two">
                                <img src="{{asset('img/frontend/resources/about-2-1-about.jpg')}}" alt="eduact">
                            ...
                            <div class="about-two__fact">
                                ...
                                <div class="about-two__fact__content">
                                    <div class="about-two__fact__count">
                                        +<span class="count-box counted">
                                            <span class="count-text" data-stop="5" data-speed="1500">5</span>
                                        </span>
                                    </div><!-- /.fact-one__count -->
                                    <h3 class="about-two__fact__title">{{__('Awesome Awards')}}</h3><!-- /.fact-one__title -->
                                </div>
                            </div><!-- /.fact-item -->
                            <div class="about-two__thumb__shape1 wow zoomIn animated" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: zoomIn;">
                                <img src="{{asset('img/frontend/shapes/about-2-shape-1.png')}}" alt="eduact">
                            </div><!-- /.about-shape-one -->
                            <div class="about-two__thumb__shape2 wow zoomIn animated" data-wow-delay="400ms" style="visibility: visible; animation-delay: 400ms; animation-name: zoomIn;">
                                <img src="{{asset('img/frontend/shapes/about-2-shape-2.png')}}" alt="eduact">
                            </div><!-- /.about-shape-two -->
                            <div class="about-two__thumb__shape3 wow zoomIn animated" data-wow-delay="400ms" style="visibility: visible; animation-delay: 400ms; animation-name: zoomIn;">
                                <img src="{{asset('img/frontend/shapes/about-2-shape-3.png')}}" alt="eduact">
                            </div><!-- /.about-shape-two -->
                            <div class="about-two__thumb__shape4 wow zoomIn animated" data-wow-delay="400ms" style="visibility: visible; animation-delay: 400ms; animation-name: zoomIn;">
                                <img src="{{asset('img/frontend/shapes/about-2-shape-4.png')}}" alt="eduact">
                            </div><!-- /.about-shape-two -->
                        </div><!-- about thumb end -->
                    </div>
                    <div class="col-xl-6 wow fadeInRight animated" data-wow-delay="100ms" style="visibility: visible; animation-delay: 100ms; animation-name: fadeInRight;">
        ...
        <section class="fact-one" style="background-image: url({{asset('img/frontend/shapes/fact-bg-1.png')}});">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="100ms" style="visibility: visible; animation-delay: 100ms; animation-name: fadeInUp;">
                        <div class="fact-one__item text-center">
                            ...
                            <div class="fact-one__count">
                                <span class="count-box counted">
                                    <span class="count-text" data-stop="30.3" data-speed="1500">30.3</span>
                                </span>k
                            </div><!-- /.fact-one__count -->
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="200ms" style="visibility: visible; animation-delay: 200ms; animation-name: fadeInUp;">
                        <div class="fact-one__item text-center">
                            ...
                            <div class="fact-one__count">
                                <span class="count-box counted">
                                    <span class="count-text" data-stop="40.5" data-speed="1500">40.5</span>
                                </span>k
                            </div><!-- /.fact-one__count -->
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInUp;">
                        <div class="fact-one__item text-center">
                            ...
                            <div class="fact-one__count">
                                <span class="count-box counted">
                                    <span class="count-text" data-stop="88.9" data-speed="1500">88.9</span>
                                </span>%
                            </div><!-- /.fact-one__count -->
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="400ms" style="visibility: visible; animation-delay: 400ms; animation-name: fadeInUp;">
                        <div class="fact-one__item text-center">
                            ...
                            <div class="fact-one__count">
                                <span class="count-box counted">
                                    <span class="count-text" data-stop="6.30" data-speed="1500">6.3</span>
                                </span>+
                            </div><!-- /.fact-one__count -->
        ...
        <section class="course-two">
            <div class="course-two__shape-top wow fadeInRight animated" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRight;"><img src="{{asset('img/frontend/shapes/course-shape-1.png')}}" alt="eduact"></div>
            <div class="container wow fadeInUp animated" data-wow-delay="200ms" style="visibility: visible; animation-delay: 200ms; animation-name: fadeInUp;">
                ...
                <div class="course-two__slider eduact-owl__carousel owl-with-shadow owl-theme owl-carousel owl-loaded owl-drag" data-owl-options="{
            &quot;items&quot;: 3,
            &quot;margin&quot;: 30,
            &quot;smartSpeed&quot;: 700,
            &quot;loop&quot;:true,
            ...
            &quot;responsive&quot;:{
                ...
                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2712px, 0px, 0px); transition: all 0.7s ease 0s; width: 5424px;"><div class="owl-item cloned" style="width: 416px; margin-right: 36px;"><div class="item">
                        <div class="course-two__item">
                            <div class="course-two__thumb">
                                <img src="{{asset('img/frontend/course/course-2-4.png')}}" alt="eduact">
                            ...
                            <div class="course-two__content">
                                ...
                                <div class="course-two__bottom">
                                    <div class="course-two__author">
                                        <img src="{{asset('img/frontend/course/author-1.png')}}" alt="eduact">
                    ...
                    </div></div><div class="owl-item cloned" style="width: 416px; margin-right: 36px;"><div class="item">
                        <div class="course-two__item">
                            <div class="course-two__thumb">
                                <img src="{{asset('img/frontend/course/course-2-5.png')}}" alt="eduact">
                                <a class="course-two__like" href="javascript:void(0);"><span class="icon-like"></span></a>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 353 177">
                                    <path d="M37 0C16.5655 0 0 16.5655 0 37V93.4816C0 103.547 4.00259 113.295 11.7361 119.737C54.2735 155.171 112.403 177 176.496 177C240.589 177 298.718 155.171 341.261 119.737C348.996 113.295 353 103.546 353 93.4795V37C353 16.5655 336.435 0 316 0H37Z"></path>
                                </svg>
                        ...
                        <div class="course-two__item">
                            <div class="course-two__thumb">
                                <img src="{{asset('img/frontend/course/course-2-6.png')}}" alt="eduact">
                                <a class="course-two__like" href="javascript:void(0);"><span class="icon-like"></span></a>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 353 177">
                                    <path d="M37 0C16.5655 0 0 16.5655 0 37V93.4816C0 103.547 4.00259 113.295 11.7361 119.737C54.2735 155.171 112.403 177 176.496 177C240.589 177 298.718 155.171 341.261 119.737C348.996 113.295 353 103.546 353 93.4795V37C353 16.5655 336.435 0 316 0H37Z"></path>
                                </svg>
                    ...
                    </div></div><div class="owl-item" style="width: 416px; margin-right: 36px;"><div class="item">
                        <div class="course-two__item">
                            <div class="course-two__thumb">
                                <img src="{{asset('img/frontend/course/course-2-1.png')}}" alt="eduact">
                                <a class="course-two__like" href="javascript:void(0);"><span class="icon-like"></span></a>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 353 177">
                                    <path d="M37 0C16.5655 0 0 16.5655 0 37V93.4816C0 103.547 4.00259 113.295 11.7361 119.737C54.2735 155.171 112.403 177 176.496 177C240.589 177 298.718 155.171 341.261 119.737C348.996 113.295 353 103.546 353 93.4795V37C353 16.5655 336.435 0 316 0H37Z"></path>
                                </svg>
                        ...
                        <div class="course-two__item">
                            <div class="course-two__thumb">
                                <img src="{{asset('img/frontend/course/course-2-2.png')}}" alt="eduact">
                                <a class="course-two__like" href="javascript:void(0);"><span class="icon-like"></span></a>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 353 177">
                                    <path d="M37 0C16.5655 0 0 16.5655 0 37V93.4816C0 103.547 4.00259 113.295 11.7361 119.737C54.2735 155.171 112.403 177 176.496 177C240.589 177 298.718 155.171 341.261 119.737C348.996 113.295 353 103.546 353 93.4795V37C353 16.5655 336.435 0 316 0H37Z"></path>
                                </svg>
                        ...
                        <div class="course-two__item">
                            <div class="course-two__thumb">
                                <img src="{{asset('img/frontend/course/course-2-3.png')}}" alt="eduact">
                                <a class="course-two__like" href="javascript:void(0);"><span class="icon-like"></span></a>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 353 177">
                                    <path d="M37 0C16.5655 0 0 16.5655 0 37V93.4816C0 103.547 4.00259 113.295 11.7361 119.737C54.2735 155.171 112.403 177 176.496 177C240.589 177 298.718 155.171 341.261 119.737C348.996 113.295 353 103.546 353 93.4795V37C353 16.5655 336.435 0 316 0H37Z"></path>
                                </svg>
                    ...
                    </div></div><div class="owl-item active" style="width: 416px; margin-right: 36px;"><div class="item">
                        <div class="course-two__item">
                            <div class="course-two__thumb">
                                <img src="{{asset('img/frontend/course/course-2-4.png')}}" alt="eduact">
                                <a class="course-two__like" href="javascript:void(0);"><span class="icon-like"></span></a>
                    ...
                    </div></div></div></div><div class="owl-nav"><button type="button" role="presentation" class="owl-prev"><span class="icon-arrow-left"></span></button><button type="button" role="presentation" class="owl-next"><span class="icon-arrow"></span></button></div><div class="owl-dots disabled"></div></div>
            </div>
            <div class="course-two__shape-bottom wow fadeInLeft animated" data-wow-delay="400ms" style="visibility: visible; animation-delay: 400ms; animation-name: fadeInLeft;"><img src="{{asset('img/frontend/shapes/course-shape-2.png')}}" alt="eduact"></div>
        </section>
        <section class="testimonial-two" style="background-image: url({{asset('img/frontend/shapes/testimonial-bg-2.png')}});">
            <div class="container">
                <div class="section-title text-center">
                    <h5 class="section-title__tagline">
                        Testimonial
                ...
                <div class="testimonial-two__carousel eduact-owl__carousel owl-with-shadow owl-theme owl-carousel owl-loaded owl-drag" data-owl-options="{
            &quot;items&quot;: 3,
            &quot;margin&quot;: 30,
            &quot;smartSpeed&quot;: 700,
            &quot;loop&quot;:true,
            ...
            &quot;responsive&quot;:{
                ...
                &quot;1200&quot;:{
                    ...
                    <!-- Testimonial Item -->
                <div class="owl-stage-outer"><div class="owl-stage" style="transition: all 0.7s ease 0s; width: 4068px; transform: translate3d(-1356px, 0px, 0px);"><div class="owl-item cloned" style="width: 416px; margin-right: 36px;"><div class="item">
                        <div class="testimonial-two__item">
                            <div class="testimonial-two__item-inner" style="background-image: url({{asset('img/frontend/shapes/testimonial-shape-2.png')}});">
                                ...
                                <div class="testimonial-two__meta">
                                    <img src="{{asset('img/frontend/resources/testimonial-2-author-1')}}.png" alt="eduact">
                        ...
                        <div class="testimonial-two__item">
                            <div class="testimonial-two__item-inner" style="background-image: url({{asset('img/frontend/shapes/testimonial-shape-2.png')}});">
                                ...
                                <div class="testimonial-two__meta">
                                    <img src="{{asset('img/frontend/resources/testimonial-2-author-2')}}.png" alt="eduact">
                        ...
                        <div class="testimonial-two__item">
                            <div class="testimonial-two__item-inner" style="background-image: url({{asset('img/frontend/shapes/testimonial-shape-2.png')}});">
                                ...
                                <div class="testimonial-two__meta">
                                    <img src="{{asset('img/frontend/resources/testimonial-2-author-3')}}.png" alt="eduact">
                    ...
                    </div></div><div class="owl-item active center" style="width: 416px; margin-right: 36px;"><div class="item">
                        <div class="testimonial-two__item">
                            <div class="testimonial-two__item-inner" style="background-image: url({{asset('img/frontend/shapes/testimonial-shape-2.png')}});">
                                <div class="testimonial-two__ratings">
                                    <span class="fa fa-star"></span>
    ...
    <section class="cta-two">
        <div class="container">
            <div class="cta-two__bg" style="background-image: url({{asset('img/frontend/shapes/cta-bg-2.jpg')}});">
                <div class="row">
