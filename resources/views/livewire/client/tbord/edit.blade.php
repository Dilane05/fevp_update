<div>
    ...
    <!-- Modal -->
    <div  wire:ignore.self class="modal fade" id="EditTbordModal" tabindex="-1" aria-labelledby="tbordModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="max-width:60%;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="tbordModalLabel">{{ __('Modifier un Tableau de Bord') }}</h5>
                ...
                <div class="modal-body">
                    <x-form-items.form wire:submit.prevent="update" class="form-modal">
                        ...
                        <div class="d-flex justify-content-end mx-4">
                            ...
                            <button type="submit" wire:click.prevent="update" class="btn btn-success rounded-pill mx-2">{{ __('Modifer') }}</button>
