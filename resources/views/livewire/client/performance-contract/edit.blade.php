<div wire:ignore.self class="modal fade" id="EditPerformanceContract" tabindex="-1" aria-labelledby="CreatePerformanceContract" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container mt-3 me-3">
                        ...
                        <button wire:click="update" class="btn btn-primary mt-3">Modifier</button>
                    </div>
                </div>
