                    ...
                    <div class="simplebar-content" style="padding: 0px;">
                        <div class="sidebar-inner px-4 pt-3">
                            ...
                            <ul class="nav flex-column pt-md-0">
                                ...
                                <li class="nav-item  {{ request()->routeIs('portal.performance_contract.index') ? 'active' : '' }}">
                                    <a href="{{ route('portal.performance_contract.index') }}" wire:navigate class="nav-link">
                                        <span class="sidebar-icon">
                                            <svg class="icon icon-sm" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 12l4.5 4.5 9-9M3 12l1.5 1.5L6 12m9-9c6.075 0 11 4.925 11 11s-4.925 11-11 11-11-4.925-11-11S5.925 1 12 1z" />
                                            </svg>
                                        </span>
                                        <span class="sidebar-text">{{ __('Contrat de performance') }}</span>
                                    </a>
                                </li>
